...
class ReviewOut(BaseModel):
    ...
    score: StrictInt
    interval: StrictInt
    easiness_factor: Union[StrictFloat, StrictInt]
    repetition: StrictInt
    next_review: datetime
    __properties: ClassVar[List[str]] = ["id", "word_id", "review_date", "score", "interval", "easiness_factor", "repetition", "next_review"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "easiness_factor": obj.get("easiness_factor"),
